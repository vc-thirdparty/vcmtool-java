...
/**
 * Copied from Guava project https://code.google.com/p/guava-libraries/
 * Specialized LineBuffer that only accepts line feed as line ending (not carriage return)
 * 
